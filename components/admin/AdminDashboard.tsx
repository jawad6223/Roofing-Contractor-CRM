...
export default function AdminDashboard() {
  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 z-50 w-64 h-screen bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex lg:flex-col lg:h-full`}>
